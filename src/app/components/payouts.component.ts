...
export class PayoutsComponent implements OnInit {
    ...
    exportCSV() {
        ...
        let apiUrl = `v2/organisations/${this.userService.CurrentCollectGroup.OrgId}/collectGroups/${this.userService.CurrentCollectGroup.GUID}/payouts/export` + '?startDate=' + start + '&endDate=' + end + '&dateTimeOffset=' + new Date().getTimezoneOffset() * -1;
        this.apiService.getData(apiUrl).then(resp => {
